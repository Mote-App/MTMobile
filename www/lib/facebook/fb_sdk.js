/*1426723447,,JIT Construction: v1648763,en_US*/
...
__d("merge",[],__annotator(function(global,require,requireDynamic,requireLazy,module,exports) {require.__markCompiled && require.__markCompiled();
"use strict";


var merge = __annotator(function(one, two) {
  return ES('Object', 'assign', false,{}, one, two);
}, {"module":"merge","line":41,"column":12});

module.exports = merge;


}, {"module":"merge","line":31,"column":15}),null);


__d("sdk.AppEvents",["Assert","sdk.Impressions","merge","sdk.Runtime"],__annotator(function(global,require,requireDynamic,requireLazy,module,exports,Assert,Impressions,merge,Runtime) {require.__markCompiled && require.__markCompiled();
...
}, {"params":[[appID, 'string', 'appID'], [eventName, 'string', 'eventName'], [valueToSum, '?number', 'valueToSum'], [params, '?object', 'params']]});}__annotator(logEvent, {"module":"sdk.AppEvents","line":52,"column":0,"name":"logEvent"}, {"params":["string","string","?number","?object"]});
...
function isValidEventName(/*string*/ eventName) /*boolean*/ {return __bodyWrapper(this, arguments, function() {
  ...
  return true;
}, {"params":[[eventName, 'string', 'eventName']],"returns":'boolean'});}__annotator(isValidEventName, {"module":"sdk.AppEvents","line":82,"column":0,"name":"isValidEventName"}, {"params":["string"],"returns":"boolean"});
...
}, {"params":[[appID, 'string', 'appID'], [purchaseAmount, 'number', 'purchaseAmount'], [currency, 'string', 'currency'], [params, '?object', 'params']]});}__annotator(logPurchase, {"module":"sdk.AppEvents","line":94,"column":0,"name":"logPurchase"}, {"params":["string","number","string","?object"]});
...
}, {"params":[[appID, 'string', 'appID']]});}__annotator(activateApp, {"module":"sdk.AppEvents","line":110,"column":0,"name":"activateApp"}, {"params":["string"]});
...
}, {"module":"sdk.AppEvents","line":7,"column":71}),null);


__d("legacy:fb.appevents",["Assert","sdk.AppEvents","FB","sdk.feature","sdk.Runtime"],__annotator(function(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,Assert,AppEvents,FB,feature,Runtime) {require.__markCompiled && require.__markCompiled();
...
FB.provide('AppEvents', {
  ...
  }, {"params":[[eventName, 'string', 'eventName'], [valueToSum, '?number', 'valueToSum'], [params, '?object', 'params']]});}, {"module":"fb.appevents","line":15,"column":11}, {"params":["string","?number","?object"]}),
  ...
  }, {"params":[[purchaseAmount, 'number', 'purchaseAmount'], [currency, 'string', 'currency'], [params, '?object', 'params']]});}, {"module":"fb.appevents","line":36,"column":14}, {"params":["number","string","?object"]}),
  ...
  }, {"module":"fb.appevents","line":57,"column":14}),
...
}, {"module":"fb.appevents","line":7,"column":86}),3);
...
__d("legacy:fb.canvas.syncrequests",["sdk.RPC","sdk.Event"],__annotator(function(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,RPC,Event) {require.__markCompiled && require.__markCompiled();
...
}, {"params":[[name, 'string', 'name'], [callbacks, 'array', 'callbacks']]});}__annotator(subscriptionAdded, {"module":"fb.canvas.syncrequests","line":10,"column":0,"name":"subscriptionAdded"}, {"params":["string","array"]});

Event.subscribe(Event.SUBSCRIBE, subscriptionAdded);


}, {"module":"fb.canvas.syncrequests","line":5,"column":60}),3);
...
__d("legacy:fb.canvas.presence",["sdk.RPC","sdk.Event"],__annotator(function(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,RPC,Event) {require.__markCompiled && require.__markCompiled();
...
}, {"params":[[name, 'string', 'name'], [callbacks, 'array', 'callbacks']]});}__annotator(subscriptionAdded, {"module":"fb.canvas.presence","line":13,"column":0,"name":"subscriptionAdded"}, {"params":["string","array"]});
...
}, {"params":[[name, 'string', 'name'], [callbacks, 'array', 'callbacks']]});}__annotator(subscriptionRemoved, {"module":"fb.canvas.presence","line":22,"column":0,"name":"subscriptionRemoved"}, {"params":["string","array"]});


}, {"module":"fb.canvas.presence","line":5,"column":56}),3);
...
__d("legacy:fb.versioned-sdk",["sdk.Runtime"],__annotator(function(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,Runtime) {require.__markCompiled && require.__markCompiled();
   
Runtime.setIsVersioned(true);


}, {"module":"fb.versioned-sdk","line":4,"column":46}),3);




}).call({}, window.inDapIF ? parent.window : window);
} catch (e) {new Image().src="http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1648763","message":"'+e.message+'"}}');}